...
node write_a_javascript_functions_004.mjs
...
import { readdir, readFile, writeFile } from "fs/promises";
   ...
   // quarterStartDate.setUTCMonth((quarter.name - 1) * 3);
    ...
    let name = "Work out 3 or more times weekly";
    let current_result = 10;
    let target_result = 39;
    // progress: 0.26;
    // success: 0.29;

    let progress = roundTwoDecimals(current_result / target_result);
    let success = roundTwoDecimals((current_result/ target_result)/quarterCompleted);
