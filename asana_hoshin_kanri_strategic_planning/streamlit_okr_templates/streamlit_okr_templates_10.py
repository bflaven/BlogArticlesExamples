...
[FILE]
streamlit run streamlit_okr_templates_10.py
...
DATA_URL = ("data/okrs_sample_sunburst_2.csv")
...
df = pd.read_csv('data/okrs_sample_sunburst_2.csv')
...
# YEP
levels = ['strategic_objective','Owner', 'Teams']
color_columns = ['OKR_Score','OKR_Score']
value_column = 'OKR_Score'



# id,strategic_objective,Owner,Teams,Key_Results,OKR_Score
...
average_score = df['OKR_Score'].sum() / df['OKR_Score'].sum()
