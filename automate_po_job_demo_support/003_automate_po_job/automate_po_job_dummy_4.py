...
[file]
python automate_po_job_dummy_4.py
...
# change it to have the correct db scheme
from automate_po_job_tabledef_streamlit import *
...
engine = create_engine(
    f'sqlite:///{URI_SQLITE_DB}', echo=True)
