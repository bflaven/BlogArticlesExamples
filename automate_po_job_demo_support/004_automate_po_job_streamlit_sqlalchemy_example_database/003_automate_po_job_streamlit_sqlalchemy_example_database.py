...
[file]
python 003_automate_po_job_streamlit_sqlalchemy_example_database.py
...
def main():
    ...
    if __name__ == "__main__":
        ...
        session.add_all([
            Mails(filename='filename_A', recipients='recipients_A', mail_object='mail_object_A',
                  mail_body='mail_body_A', mail_search_tags='mail_search_tags_A_1, mail_search_tags_A_2, mail_search_tags_A_3'),
            Mails(filename='filename_B', recipients='recipients_B', mail_object='mail_object_B',
                  mail_body='mail_body_B', mail_search_tags='mail_search_tags_B_1, mail_search_tags_B_2, mail_search_tags_B_3'),
            Mails(filename='filename_C', recipients='recipients_C', mail_object='mail_object_C',
                  mail_body='mail_body_C', mail_search_tags='mail_search_tags_C_1, mail_search_tags_C_2, mail_search_tags_C_3')
            ])
        session.commit()
