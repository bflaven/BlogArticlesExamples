...
[file]
python 004_automate_po_job_streamlit_sqlalchemy_example_database.py
...
def main():
    ...
    if __name__ == "__main__":
        ...
        session.add_all([
            Mails(filename='filename_XXX', recipients='recipients_XXX', mail_object='mail_object_XXX',
                  mail_body='mail_body_XXX', mail_search_tags='mail_search_tags_XXX_1, mail_search_tags_XXX_2, mail_search_tags_XXX_3')
            ])
        session.commit()
