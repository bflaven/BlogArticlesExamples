...
"""
[path]
/Users/brunoflaven/Documents/01_work/blog_articles/extending_streamlit_usage/005_other_nlp_attempts/

[file]
python example_text_classification_6.py
...
for feature in tags_set:
    dtf["tags_" +
        feature] = dtf["tags"].apply(lambda x: utils_ner_features(x, feature))
