...
[file]
streamlit run streamlit_command_app_5.py
...
location = st.multiselect("Where do you stay", ("London",
                                                "New-York", "Accra", "Kiev", "Berlin", "New-Delhi"))
st.caption('You have to select minimum 4 cities.')
...
if st.button("launcher BTN_2"):
    ...
    command_three = "python launcher_3.py bruno anne arthur louise"
...
if st.button("launcher BTN_3"):
    ...
    command_four = "python launcher_3.py "+ location[0] + " " + location[1] + " " + location[2]+ " " + location[3]
