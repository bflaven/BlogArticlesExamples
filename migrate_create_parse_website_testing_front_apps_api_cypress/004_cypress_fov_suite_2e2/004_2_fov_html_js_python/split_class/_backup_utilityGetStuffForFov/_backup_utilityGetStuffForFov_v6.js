  ...
  #deviceType;
    ...
    getSelectionVerifier(brandLang) {
        ...
        switch (brandLang) {
            ...
            case 'F24_EN':
                // var tata = 'F24_EN';
                require ('fov_sub_class_'+brandLang+'.js');
...
var MetaDataStuff = {
    ...
    page_tag_environnement: [
        ...
        ['url', 'slug', '%D8%A8%D9%8A%D8%A6%D8%A9/'],
        ['name_tag', 'viewport', 'width=device-width, initial-scale=1.0, viewport-fit=cover'],
        ['property_tag', 'og:image', 'https://static.france24.com/infographies/meta_og_twcards/F24_obs_ar.png'],
        ['property_tag', 'og:locale', 'ar_AR'],
        ['property_tag', 'og:site_name', 'فرانس 24 – مراقبون'],
...
var MetaDataStuff = {
    ...
    page_tag_rumeur: [
        ...
        ['url', 'slug', '%D8%B4%D8%A7%DB%8C%D8%B9%D9%87/'],
        ['name_tag', 'viewport', 'width=device-width, initial-scale=1.0, viewport-fit=cover'],
        ['property_tag', 'og:image', 'https://static.rfi.fr/meta_og_twcards/RFI_obs_fa.png'],
        ['property_tag', 'og:locale', 'fa_IR'],
        ['property_tag', 'og:site_name', 'ناظران  - RFI'],
        ['property_tag', 'og:type', 'website'],
        ['property_tag', 'og:title', 'شایعه: اخبار، پادکست، ویدیو و تحلیل - ناظران - ار.اف.ای'],
        ['property_tag', 'og:description', 'اخبار و شرح و تحلیل\u200cها را شایعه در ناظران ار.اف.ای بخوانید و بشنوید'],
        ['property_tag', 'og:url', 'https://observers.france24.com/fa/%DA%AF%D8%B1%D9%88%D9%87-%D9%88%D8%A7%DA%98%D9%87/%D8%B4%D8%A7%DB%8C%D8%B9%D9%87/'],
        ['property_tag', 'fb:app_id', '113191652055439'],
        ...
        ['name_tag', 'apple-mobile-web-app-capable', 'yes'],
        ['name_tag', 'apple-mobile-web-app-capable', 'yes'],
        ['title_tag', 'title', 'شایعه: اخبار، پادکست، ویدیو و تحلیل - ناظران - ار.اف.ای']
