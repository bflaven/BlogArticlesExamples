...
[file]
python 001_META_web_scraping_beautifulsoup.py
...
# [['slug', 'bruno-flaven-resume-cv'], ['meta_tag', 'viewport', 'width=device-width, initial-scale=1.0'], ['meta_tag', 'robots', 'max-image-preview:large'], ['meta_tag', 'generator', 'WordPress 6.1.1'], ['meta_tag', 'og:type', 'article'], ['meta_tag', 'og:title', 'Bruno Flaven'], ['meta_tag', 'og:url', 'https://flaven.fr/bruno-flaven-resume-cv/'], ['meta_tag', 'og:description', 'Bruno Flaven Digital Project Manager Email : info@flaven.fr Others @bflaven on Github On Youtube On Amazon On Linkedin On Twitter Experience Since 2013 FMM (France Medias Monde), Paris. Project Man…'], ['meta_tag', 'article:published_time', '2013-09-17T14:50:30+00:00'], ['meta_tag', 'article:modified_time', '2021-12-12T12:29:44+00:00'], ['meta_tag', 'og:site_name', '@ Flaven.net'], ['meta_tag', 'og:image', 'https://s0.wp.com/i/blank.jpg'], ['meta_tag', 'og:locale', 'en_US'], ['meta_tag', 'twitter:text:title', 'Bruno Flaven'], ['meta_tag', 'twitter:image', 'http://flaven.fr/wp-content/uploads/userphoto/1.jpg?w=144'], ['meta_tag', 'twitter:image:alt', 'Bruno Flaven'], ['meta_tag', 'twitter:card', 'summary'], ['title_tag', 'title', 'Bruno Flaven – @ Flaven.net']]
