...
class NFT:
    ...
    face = ["White", "Black"]
    face_weights = [65, 35] # must be equal to 100
    ...
    def create_metadata(self):
        """ Create Json file for each image """
    ...
    def you_are_good(self):
        
        self.TOTAL_IMAGES

        
        print(f'RESULT :: You are good '+str(self.TOTAL_IMAGES)+' nft has been created!')
