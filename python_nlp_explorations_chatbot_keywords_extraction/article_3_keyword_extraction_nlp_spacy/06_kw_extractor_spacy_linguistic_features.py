...
python 06_kw_extractor_spacy_linguistic_features.py
...
# 2. run on a given text
sample_file = io.open("data/v9094e.txt", 'r',encoding="iso-8859-1")
input_text = sample_file.read()
