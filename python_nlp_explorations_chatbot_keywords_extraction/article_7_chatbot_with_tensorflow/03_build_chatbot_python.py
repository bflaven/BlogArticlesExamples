...
cd /Users/brunoflaven/Documents/02_copy/_000_IA_bruno_light/_my_article_python-explorations/git_repo_python_explorations_nlp/article_7_chatbot_with_tensorflow/

python 03_build_chatbot_python.py
...
FILENAME           = "amazon_english_faq.txt"
#Global Variables
...
#Response Fetching
flag=True
print(colored("NONO:\nI am Nono, I have all the answers If you want to exit, type Ciao",'blue',attrs=['bold']))
while(flag==True):
    print(colored("\nYOU:",'red',attrs=['bold']))
    u_input = input()
    ...
    if(u_input!='ciao'):
        ...
        flag=False
        print(colored("\nNono: Bye! take care..",'blue', attrs=['bold']))
