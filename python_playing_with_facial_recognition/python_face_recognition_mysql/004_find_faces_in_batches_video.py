...
python 004_find_faces_in_batches_video.py

- caution use a very short film because your computre may crash
...
# Open video file
video_capture = cv2.VideoCapture("./images/unknown/portrait_young_stylish_woman_graffiti_artist_small.mp4")
