...
[file]
python 001a_web_scraping_selenium_supernyv.py
...
posts = soup.find_all("div", class_="post-wrapper-hentry")
...
#         projected_jobs = data[0].a.string
#         """Remove comma -->"""
#         projected_jobs = "".join(projected_jobs.split(","))
#         median_salary = data[1].a.string.lstrip("$")
#         """Remove comma -->"""
#         median_salary = "".join(median_salary.split(","))
#         try:
#             education_needed = data[2].a.string
#         except Exception:
#             education_needed = "Not required"
        
#         df.loc[index] = [title, rank, projected_jobs,
#                 median_salary, education_needed]
#         index += 1
