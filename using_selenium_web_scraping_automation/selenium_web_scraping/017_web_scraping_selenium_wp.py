...
python 017_web_scraping_selenium_wp.py it_IT
python 017_web_scraping_selenium_wp.py fr_FR
python 017_web_scraping_selenium_wp.py es_ES
python 017_web_scraping_selenium_wp.py ru_RU
python 017_web_scraping_selenium_wp.py zh_CN
python 017_web_scraping_selenium_wp.py en_EN
...
# Grab the argument passed with the script e.g python 017_web_scraping_selenium_wp.py pt_PT
iso_language_code = str(sys.argv[1])
print(f"\n--- iso_language_code ::: {iso_language_code}")

# look for labels IN WP admin with a CSS selector
